const ch2en = {
  ...
  "设置接入节点": "Node Setting",
  "语言": "Language",
  "配置需连接的节点": "Config node to connect",
  "选择节点": "Select Node",
  "通过MetaMask连接夸克": "Connect Quark Chain by Metamask",
  "测试网": "Testnet ",
  "主网": "Mainnet ",
  "自定义": "Customized",
  "本地节点": "Local Node: ",
  "自定义节点": "Customized Node",
  "测试网节点": "Testnet Node",
  "主网节点": "Mainnet Node",
  "日志输出": "Logout",
  "添加合约": "Add Contract",
  ...
  "分享": "Share",
  "我的合约": "My Contracts",
  "公共库(可直接调用)": "Public Library",
  "示例(仅供参考)": "Demo",
  "分享合约的地址列表": "Addresses of Contracts",
  "同步合约": "Sync Contract",
  "xxx分享的合约": "xxx's shared contract",
  "清空日志": "Clean Log",
  "编号": "No",
  "选择Chain ID": "Select Chain ID",
  "选择Shard ID": "Select Share ID",
  "选择账号": "Select Account",
  "复制账号": "Copy Account",
  "添加账号": "Add Account",
  "查询账号": "Search Account",
  "请选择待编译文件": "Select contract to be compiled",
  ...
  "加载": "Load",
  "请输入合约文件名称": "Please input name of contract",
  "请选择Solidity编译器版本": "Please select compiler version of solidity",
  "请输入自定义节点地址": "Please input node address",
  "合约ABI信息": "ABI information of contract",
  "复制ABI": "Copy ABI",
  "合约BIN信息": "BIN information of contract",
  "复制BIN": "Copy BIN",
  "新账号": "New Account",
  "账户私钥": "Private Key",
  "自动生成": "Auto generated",
  "账户地址": "Address",
  "账户资产信息": "Asset information of account",
  ...
  "写入并可支付类接口": "Writable && Payable Interface",
  ...
  "确认分享后，您在本IDE中的编码将通过类似直播的方式被分享出去。": "If confrimed, the procedure of contract coding will be shared.",
  "分享代码": "Confirm",
  "取消": "Cancel",
  "即将上线，敬请期待": "It will be online soon...",
  "请选择需要获取其ABI/BIN信息的合约":"Please select the contract firstly.",
  "去中心化应用展示": "DApp View",
